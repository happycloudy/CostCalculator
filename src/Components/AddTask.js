                ...
                <form className="AddTask" action="/addworkertask" method="POST">
                    ...
                    <Row>
                        <Col>
                            ...
                            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                                <Hint options={this.state.workers} allowTabFill className="WorkerField">
                                    <input className="WorkerField" value={this.state.text}
                                           onChange={e => this.handleChange(e)} name="name" required/>
                                </Hint>
                            </div>
                        </Col>
                        ...
                        <Col>
                            ...
                            <NotNumberToolTipField name="time" setIsSubmitted={(isSubmitted)=>{this.setIsSubmitted(isSubmitted)}}/>
                        </Col>
                    </Row>
